package arz.ore.hpots.commands;

import arz.ore.hpots.ArzorePots;
import arz.ore.hpots.utils.DataFile;
import arz.ore.hpots.utils.Utils;
...
public class PotCommands {
    private static final ArzorePots plugin = ArzorePots.getInstance();

    @Command(value = {"potion", "pot", "pots"}, async = true, quoted = false, description = "Potion Help Command.")
    @Permission(value = "ArzorePots.admin", message = "You do not have permission to access this command!")
